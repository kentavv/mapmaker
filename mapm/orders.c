...
void extend_order(MAP *placed, /* starting order, must be total long */ PLACEME **unplaced, int *num_unplaced,
                  real npt_thresh, /* both are side-effected, and may have NO_LOCUS */ bool print_anyway) {
    int i, j, total;
