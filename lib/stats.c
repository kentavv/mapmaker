...
void print_normal(NORMAL_TEST *to_be_printed, real lamda) {
    if (lamda < 0) {
        ...
        print("  3   ");
        nl();
        sprintf(ps, "%s ", rs(6.2, to_be_printed->mean));
        pr();
        sprintf(ps, "%s ", rs(6.2, to_be_printed->sigma));
        pr();
        sprintf(ps, " %s   ", rs(6.2, to_be_printed->skew));
        pr();
        sprintf(ps, " %s   ", rs(6.2, to_be_printed->kurt));
        pr();
        sprintf(ps, " %s     |  ", rs(4.2, to_be_printed->quart_ratio));
        pr();
        sprintf(ps, " %s  ", rs(4.2, to_be_printed->within_one_fourth));
        pr();
        sprintf(ps, " %s ", rs(4.2, to_be_printed->within_one_half));
        pr();
        sprintf(ps, " %s ", rs(4.2, to_be_printed->within_one));
        pr();
        sprintf(ps, " %s ", rs(4.2, to_be_printed->within_two));
        pr();
        sprintf(ps, " %s   ", rs(4.2, to_be_printed->within_three));
        pr();
        /*nl();*/
        print("-------------------------------------------------------------");
        print("----------------");
        ...
        sprintf(ps, "%lf  ", lamda);
        pr();
        sprintf(ps, "%.2lf ", to_be_printed->mean);
        pr();
        sprintf(ps, " %.2lf  ", to_be_printed->sigma);
        pr();
        sprintf(ps, " %.2lf ", to_be_printed->skew);
        pr();
        sprintf(ps, " %.2lf ", to_be_printed->kurt);
        pr();
        sprintf(ps, " %.2lf   ", to_be_printed->quart_ratio);
        pr();
        sprintf(ps, " %.2lf ", to_be_printed->within_one_fourth);
        pr();
        sprintf(ps, " %.2lf ", to_be_printed->within_one_half);
        pr();
        sprintf(ps, " %.2lf ", to_be_printed->within_one);
        pr();
        sprintf(ps, " %.2lf ", to_be_printed->within_two);
        pr();
        sprintf(ps, " %.2lf ", to_be_printed->within_three);
        pr();
        nl();
        print("-------------------------------------------------------------");
        print("----------------");
