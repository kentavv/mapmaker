...
real lamda;
{
	...
	print("  3   ");
	nl();
	sf(ps,"%s ",rs(6.2,to_be_printed->mean));pr();
	sf(ps,"%s ",rs(6.2,to_be_printed->sigma));pr();
	sf(ps," %s   ",rs(6.2,to_be_printed->skew));pr();
	sf(ps," %s   ",rs(6.2,to_be_printed->kurt));pr();
	sf(ps," %s     |  ",rs(4.2,to_be_printed->quart_ratio));pr();
	sf(ps," %s  ",rs(4.2,to_be_printed->within_one_fourth));pr();
	sf(ps," %s ",rs(4.2,to_be_printed->within_one_half));pr();
	sf(ps," %s ",rs(4.2,to_be_printed->within_one));pr();
	sf(ps," %s ",rs(4.2,to_be_printed->within_two));pr();
	sf(ps," %s   ",rs(4.2,to_be_printed->within_three));pr();
	/*nl();*/
	print("-------------------------------------------------------------");
	print("----------------");
	nl();
	...
	sf(ps,"%lf  ",lamda);pr();
	sf(ps,"%.2lf ",to_be_printed->mean);pr();
	sf(ps," %.2lf  ",to_be_printed->sigma);pr();
	sf(ps," %.2lf ",to_be_printed->skew);pr();
	sf(ps," %.2lf ",to_be_printed->kurt);pr();
	sf(ps," %.2lf   ",to_be_printed->quart_ratio);pr();
	sf(ps," %.2lf ",to_be_printed->within_one_fourth);pr();
	sf(ps," %.2lf ",to_be_printed->within_one_half);pr();
	sf(ps," %.2lf ",to_be_printed->within_one);pr();
	sf(ps," %.2lf ",to_be_printed->within_two);pr();
	sf(ps," %.2lf ",to_be_printed->within_three);pr();
	nl();
	print("-------------------------------------------------------------");
	print("----------------");
	nl();
